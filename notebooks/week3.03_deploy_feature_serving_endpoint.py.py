...
preds_df = (
    preds_df.groupby("player_name")
    .agg({"Predicted_Points": "mean", "team_abbreviation": "last", "age": "last"})
    .reset_index()
)
...
print(
    "Available endpoints:",
    [endpoint.name for endpoint in feature_serving.workspace.serving_endpoints.list()],
)
